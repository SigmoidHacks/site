...
<Banner sx={{marginTop: "25px"}}>

<h1 style={{ marginTop: "100px" }}>Sigmoid Hacks</h1>
...
<h2 style={{ color: "primary", fontSize: "35px" }}>Discord</h2>
</Box>
</motion.div>
</a>
...
<motion.div
 ...
 >
<Box variant="card" style={{ backgroundColor: "black" }}>
<h2 style={{ color: "primary", fontSize: "35px" }}>Devpost</h2>
</Box>
</motion.div>
</a>
</Gallery>
...
<div>
<Box variant="card" style={{ backgroundColor: "#00bdde" }}>
<Text
  style={{
    color: "primary",
    fontSize: 35,
