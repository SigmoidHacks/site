...
<motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }} style={{ borderRadius: "25px", textAlign: "center", height: "300px", backgroundColor: "#ff8c37", color: "white", boxShadow: "1000px" }}>

# Beginners & Advanced Participants Welcome!

</motion.div>

<motion.div initial={{boxShadow:"100px"}} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }} style={{ borderRadius: "25px", textAlign: "center", height: "300px", backgroundColor: "#5bc0de", color: "white"}}>
